const Experience = props => {
  ...
  return (
    <section className="flex container mx-auto max-w-screen-xl my-32 w-full gap-10" id="about">
      <div key={experience.id} className='grid grid-cols-1 md:grid-cols-2 w-full bg-stone-100 rounded-2xl'>
        <div className='w-full'>
          <img
            src={experience.image}
            alt={experience.title}
            className='w-full md:w-[550px] h-96 rounded-t-2xl md:rounded-l-2xl md:rounded-t-none object-cover'
          />
        </div>
        <div className='flex flex-col w-full md:w-2/3 items-start p-8 gap-5'>

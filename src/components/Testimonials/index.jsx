    ...
    return (
        <section className='flex flex-col container mx-auto max-w-screen-xl pt-20 gap-8' id='testimoni'>
            ...
            <div className='relative w-[1188px]'>
                <button onClick={scrollLeft} className='absolute left-0 top-1/2 transform -translate-y-1/2 bg-gray-200 p-2 rounded-full shadow-md z-10 hover:bg-orange-400 hover:text-white'>
                    <HiChevronLeft />
                </button>
                ...
                <button onClick={scrollRight} className='absolute right-0 top-1/2 transform -translate-y-1/2 bg-gray-200 p-2 rounded-full shadow-md rotate-180 hover:bg-orange-400 hover:text-white'>
                    <HiChevronLeft />
                </button>
            </div>
        </section>
